...
class JuniperAutoloadFlow(AbstractAutoloadFlow):
    """
    ...
    def _build_root(self, resource_model):
        """
        ...
        resource_model.contact_name = self._snmp_handler.get_property('SNMPv2-MIB', 'sysContact', '0')
        resource_model.system_name = self._snmp_handler.get_property('SNMPv2-MIB', 'sysName', '0')
        resource_model.location = self._snmp_handler.get_property('SNMPv2-MIB', 'sysLocation', '0')
    ...
    def _build_chassis(self, resource_model):
        """
    ...
    def _build_power_modules(self, resource_model, chassis_table):
        """
    ...
    def _build_modules(self, resource_model, chassis_table):
        """
    ...
    def _build_sub_modules(self, resource_model, module_table):
        """
    ...
    def _build_ports(self, resource_model, chassis_table, module_table, sub_module_table):
        """
    ...
    def _autoload_flow(self, supported_os, resource_model):
        ...
        self._build_root(resource_model)
        chassis_table = self._build_chassis(resource_model)
        power_port_table = self._build_power_modules(resource_model, chassis_table)
        module_table = self._build_modules(resource_model, chassis_table)
        sub_module_table = self._build_sub_modules(resource_model, module_table)
        port_table = self._build_ports(resource_model, chassis_table, module_table, sub_module_table)
