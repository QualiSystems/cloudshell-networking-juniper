...
class TestJuniperGenericPort(TestCase):
    ...
    def test_get_snmp_attribute(self, snmp_mib_object):
        instance = JuniperGenericPort(self._index, self._snmp_service, self._resource_model)
        value = Mock()
        ...
        self._snmp_service.get_property.assert_called_once_with(snmp_mib_object.return_value)

    @patch('cloudshell.networking.juniper.autoload.entities.JuniperGenericPort.port_name',
           new_callable=PropertyMock)
    @patch('cloudshell.networking.juniper.autoload.entities.JuniperGenericPort._get_snmp_attribute')
    ...
    #     self.assertIs(instance._snmp_handler, sel)
    ...
    #     self.assertIs(instance.index, self._index)
    #     self.assertIs(instance._snmp_handler, self._snmp_service)
    #     self.assertIs(instance.shell_name, self._shell_name)
    #     self.assertIs(instance.shell_type, self._shell_type)
    #     self.assertIs(instance._resource_name, self._resource_name)
    #     self.assertIsNone(instance._port_phis_id)
    ...
    #     snmp_attribute = Mock()
    #     result = Mock()
    #     self._snmp_service.get_property.return_value = result
    #     instance = self._create_port_instance()
    #     self.assertIs(instance._get_snmp_attribute(mib, snmp_attribute), result)
    #     self._snmp_service.get_property.assert_called_once_with(mib, snmp_attribute, self._index)
    #
